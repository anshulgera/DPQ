...
- **D18g — PR 5 split (refines D16):** PR 5 is split into **5a** (visibility timeout, redelivery, the DLQ sink) and **5b** (TTL and the drain limit) to stay near the ~400-line PR budget.
